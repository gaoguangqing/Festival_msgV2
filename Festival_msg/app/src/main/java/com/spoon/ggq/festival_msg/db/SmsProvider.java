...
public class SmsProvider extends ContentProvider{
    ...
    private static final String AUTHORUTY="com.spoon.ggq.festival.SmsProvider";
    public static final Uri URI_SMS_ALL=Uri.parse("content://"+AUTHORUTY+"/sms");
    ...
    static {
        ...
        matcher.addURI(AUTHORUTY,"sms",SMS_ALL);
        matcher.addURI(AUTHORUTY,"sms/#",SMS_ONE);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
       int match=matcher.match(uri);
        ...
        Cursor c=mDb.query(SendMsg.TABLE_NAME,projection,selection,selectionArgs,null,null,sortOrder);
